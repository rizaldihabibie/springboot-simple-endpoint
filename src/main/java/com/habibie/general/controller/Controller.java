...
import com.habibie.general.model.ProvApiDelete;
import com.habibie.general.model.Upoint;
...
public class Controller {
    ...
    public ResponseEntity test(Upoint data) {
        System.out.println("Oke");
        HashMap<String, Object> responseBody = new HashMap();
        responseBody.put("result", HttpStatus.OK);
        responseBody.put("subs_id", "ini subs");
        responseBody.put("trx_id", data.getTrx_id());
        responseBody.put("error_code", null);
        responseBody.put("error_info", null);
      return new ResponseEntity<>(responseBody, HttpStatus.OK);
    }
    
    @PostMapping(path="/gallery/delete",consumes = "application/json")
    public ResponseEntity test2(HttpServletRequest httpServletRequest,@RequestBody ProvApiDelete data) {
        System.out.println("EVOA_MSG_ID : "+httpServletRequest.getHeader("EVOA_MSG_ID"));
        System.out.println("EVOA_PHONENUMBER: "+httpServletRequest.getHeader("EVOA_PHONENUMBER"));
        System.out.println("Content id : "+data.getContentid());
        System.out.println("delete upoint : "+data.getDeleteupoint());
        HashMap<String, Object> responseBody = new HashMap();
        responseBody.put("code", "OK");
